...
return [
    ...
    */
    ...
    'awards_' => 'badge|badges',                // Use trans_choice instead of __

    'awardcase'   => 'badgecase',                 // use __
    'awardcases'  => 'badgecases',               // use __
    'awardcases_' => 'badgecase|badgecases',    // Use trans_choice instead of __
