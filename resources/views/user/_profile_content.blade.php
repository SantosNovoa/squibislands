...
@endif
    ...
    <div class="col-md-6 mb-4 profile-assets d-flex flex-column" style="clear:both;">
        ...
        <div class="card profile-inventory profile-assets-card flex-grow-1">
            <div class="card-body text-center d-flex flex-column">
                <h5 class="card-title">Inventory</h5>
                <div class="profile-assets-content flex-grow-1">
                    @if(count($items))
                        <div class="row">
