@php
    ...
    $donateableCurrencies = in_array('any', $data['currency_ids']) ? \App\Models\Currency\Currency::pluck('name', 'id')->toArray() : 
        \App\Models\Currency\Currency::whereIn('id', $data['currency_ids'])->pluck('name', 'id')->toArray();
@endphp
