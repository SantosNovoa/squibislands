...
<p>A custom CSS file can be uploaded here. This will be added to the page after the inclusion of other CSS files, and reuploading the file will replace the original. Making changes to the site code is recommended for large changes to the layout, but this upload can be used for simple updates.</p>
<div class="card mb-3">
    <div class="card-body">
        <div>
            <h3 class="card-heading">CSS <a href="{{ asset('css/custom.css') }}" class="btn btn-info btn-sm float-right">View Current</a></h3>
