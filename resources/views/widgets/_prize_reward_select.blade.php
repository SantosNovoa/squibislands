                ...
                <tr class="reward-row">
                    ...
                    <td class="reward-row-select">
                        ...
                        @elseif($reward->rewardable_type == 'Award')
                            {!! Form::select('rewardable_id[]', $awards, $reward->rewardable_id, ['class' => 'form-control award-select selectize', 'placeholder' => 'Select Badge']) !!}
                        @elseif($reward->rewardable_type == 'Gear')
                            {!! Form::select('rewardable_id[]', $gear, $reward->rewardable_id, ['class' => 'form-control gear-select selectize', 'placeholder' => 'Select Gear']) !!}
                        @elseif($reward->rewardable_type == 'Weapon')
                            {!! Form::select('rewardable_id[]', $weapons, $reward->rewardable_id, ['class' => 'form-control weapon-select selectize', 'placeholder' => 'Select Weapon']) !!}
                        @elseif($reward->rewardable_type == 'Recipe')
                            {!! Form::select('rewardable_id[]', $recipes, $reward->rewardable_id, ['class' => 'form-control recipe-select selectize', 'placeholder' => 'Select Recipe']) !!}
                        @endif
                    </td>
