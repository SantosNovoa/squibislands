...
=======
@section('title') Link Account @endsection

@section('content')
<h1>Link Account</h1>
<p>Your account does not have any external social media accounts linked to it. For the purposes of verifying your identity, you must link at least one of the following accounts to your {{ config('lorekeeper.settings.site_name', 'Lorekeeper') }} account. This will give you access to more personalised features of this site.</p>
