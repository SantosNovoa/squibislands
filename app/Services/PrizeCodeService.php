...
class PrizeCodeService extends Service
{
    ...
    public function createPrize($data, $user)
    {
        ...
        try {
            ...
            $this->logAdminAction($user, 'Created Code', 'Created code ' . $prize->name);
    ...
    public function updatePrize($prize, $data, $user)
    {
        ...
        try {
            ...
            $this->logAdminAction($user, 'Updated Code', 'Updated code ' . $prize->name);
    ...
    public function deletePrize($prize)
    {
        ...
        try {
            ...
            $this->logAdminAction($this->user(), 'Deleted Code', 'Deleted code ' . $prize->name);
