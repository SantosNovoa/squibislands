    ...
    **********************************************************************************************/
    ...
    public function getNewSubmission(Request $request) {
        ...
        return view('home.create_submission', [
            ...
            'galleries'              => Gallery::where('submissions_open', 1)->orderBy('sort')->pluck('name', 'id'),
    ...
    public function getEditSubmission(Request $request, $id) {
        ...
        $count['all'] = Submission::submitted($submission->prompt_id, $submission->user_id)->count();
        $count['Hour'] = Submission::submitted($submission->prompt_id, $submission->user_id)->where('created_at', '>=', now()->startOfHour())->count();
        $count['Day'] = Submission::submitted($submission->prompt_id, $submission->user_id)->where('created_at', '>=', now()->startOfDay())->count();
        $count['Week'] = Submission::submitted($submission->prompt_id, $submission->user_id)->where('created_at', '>=', now()->startOfWeek())->count();
        $count['Month'] = Submission::submitted($submission->prompt_id, $submission->user_id)->where('created_at', '>=', now()->startOfMonth())->count();
        $count['Year'] = Submission::submitted($submission->prompt_id, $submission->user_id)->where('created_at', '>=', now()->startOfYear())->count();
