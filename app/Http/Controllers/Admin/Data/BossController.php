    ...
    **********************************************************************************************/
    ...
    public function postCreateEditBoss(Request $request, BossService $service, $id = null) {
        ...
        $data = $request->only([
            ...
            'total_health', 'type', 'can_attack_after_defeat', 'is_rewards_only_for_participants', 'attack_methods', 'attack_methods_info',
            'rewardable_type', 'rewardable_id', 'quantity', 'threshold',
        ]);
