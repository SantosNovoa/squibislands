    ...
    */
    ...
    public function postCreateCharacter(Request $request, CharacterManager $service) {
        ...
        $data = $request->only([
            ...
            'image', 'thumbnail', 'image_description', 'transformation_id','transformation_info','transformation_description', 'theme'
        ]);
    ...
    public function postCreateMyo(Request $request, CharacterManager $service) {
        ...
        $data = $request->only([
            ...
            'artist_id', 'artist_url',
            'species_id', 'subtype_id', 'rarity_id', 'feature_id', 'feature_data',
            'image', 'thumbnail', 'transformation_id','transformation_info','transformation_description', 'theme'
        ]);
