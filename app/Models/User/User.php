...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function getDisplayNameAttribute()
    {
        ...
        return ($this->is_banned ? '<strike>' : '')
            . '<a href="' . $this->url . '" class="display-user" style="' . $colorStyle . ($this->is_deactivated ? 'opacity: 0.5;' : '') . '">'
            . '<i class="' . ($this->rank->icon ? $this->rank->icon : 'fas fa-user') . ' mr-1" style="' . $colorStyle . 'opacity: 50%;"></i>'
            . $this->name
            . '</a>'
    ...
    public function getCommentDisplayNameAttribute()
    {
        ...
        return ($this->is_banned ? '<strike>' : '')
            . '<small><a href="' . $this->url . '" class="btn btn-primary btn-sm" style="' . $colorStyle . ($this->is_deactivated ? 'opacity: 0.5;' : '') . '">'
            . '<i class="' . ($this->rank->icon ? $this->rank->icon : 'fas fa-user') . ' mr-1" style="opacity: 50%;"></i>'
            . $this->name
            . '</a></small>'
            . ($this->is_banned ? '</strike>' : '');
    }
